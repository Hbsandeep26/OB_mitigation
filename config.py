...
TELEMETRY_START_TIME = _setting("TELEMETRY_START_TIME", "09:15")
FRESH_ENTRY_CUTOFF_TIME = _setting("FRESH_ENTRY_CUTOFF_TIME", "15:10")
...
DIRECTIONAL_MIN_WING_STEPS = _int_setting("DIRECTIONAL_MIN_WING_STEPS", 4)
...
MTF_VALIDATED_SYMBOLS = _list_setting("MTF_VALIDATED_SYMBOLS", ["NIFTY", "SENSEX", "RELIANCE"])
MTF_ENTRY_START = _setting("MTF_ENTRY_START", "09:30")
MTF_ENTRY_CUTOFF = _setting("MTF_ENTRY_CUTOFF", "13:45")
MTF_MIN_SCORE = _int_setting("MTF_MIN_SCORE", 90)
MTF_MIN_LIVE_RR = _float_setting("MTF_MIN_LIVE_RR", 1.0)
MTF_MAX_SIGNAL_AGE_SECONDS = _int_setting("MTF_MAX_SIGNAL_AGE_SECONDS", 75)
MTF_MAX_ENTRY_DRIFT_ATR = _float_setting("MTF_MAX_ENTRY_DRIFT_ATR", 0.25)
MTF_SLIPPAGE_BUFFER_BPS = _float_setting("MTF_SLIPPAGE_BUFFER_BPS", 1.5)

# --- CREDIT SWEEP PAPER STRATEGY ---
CREDIT_SWEEP_ENABLED = _bool_setting("CREDIT_SWEEP_ENABLED", True)
CREDIT_SWEEP_PAPER_ONLY = _bool_setting("CREDIT_SWEEP_PAPER_ONLY", True)
CREDIT_SWEEP_SYMBOLS = _list_setting("CREDIT_SWEEP_SYMBOLS", ["NIFTY", "SENSEX", "RELIANCE"])
CREDIT_SWEEP_ENTRY_START = _setting("CREDIT_SWEEP_ENTRY_START", "09:30")
CREDIT_SWEEP_ENTRY_CUTOFF = _setting("CREDIT_SWEEP_ENTRY_CUTOFF", "13:45")
CREDIT_SWEEP_EXIT_TIME = _setting("CREDIT_SWEEP_EXIT_TIME", "15:00")
CREDIT_SWEEP_MIN_SCORE = _int_setting("CREDIT_SWEEP_MIN_SCORE", 75)
CREDIT_SWEEP_RR_TARGET = _float_setting("CREDIT_SWEEP_RR_TARGET", 0.75)
CREDIT_SWEEP_RISK_BUDGET = _float_setting("CREDIT_SWEEP_RISK_BUDGET", 300.0)
CREDIT_SWEEP_MAX_SIGNAL_AGE_SECONDS = _int_setting("CREDIT_SWEEP_MAX_SIGNAL_AGE_SECONDS", 90)
CREDIT_SWEEP_VOLUME_MULTIPLIER = _float_setting("CREDIT_SWEEP_VOLUME_MULTIPLIER", 1.15)
CREDIT_SWEEP_SWING_LOOKBACK = _int_setting("CREDIT_SWEEP_SWING_LOOKBACK", 5)
CREDIT_SWEEP_SWEEP_BUFFER_PCT = _float_setting("CREDIT_SWEEP_SWEEP_BUFFER_PCT", 0.00005)
CREDIT_SWEEP_MAX_ATR_PCT = _float_setting("CREDIT_SWEEP_MAX_ATR_PCT", 0.018)
CREDIT_SWEEP_TARGET_NEAR_FRACTION = _float_setting("CREDIT_SWEEP_TARGET_NEAR_FRACTION", 0.10)
CREDIT_SWEEP_STOP_NEAR_FRACTION = _float_setting("CREDIT_SWEEP_STOP_NEAR_FRACTION", 0.20)
CREDIT_SWEEP_PAPER_QUANTITY = _int_setting("CREDIT_SWEEP_PAPER_QUANTITY", 1)
